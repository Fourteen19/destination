...
class SelfAssessment extends Model
{
     ...
     */
    protected $fillable = [
        'user_id', 'year', 'completed', 'career_readiness_average', 'career_readiness_score_1', 'career_readiness_score_2', 'career_readiness_score_3', 'career_readiness_score_4', 'career_readiness_score_5'
    ];
    ...
    {
        return $this->tags->filter(function (SystemTag $tag) use ($type) {
            return ($tag->type === $type) && ($tag->live == "Y") && ( ($tag->pivot->assessment_answer <= 2) || ($tag->pivot->score > 0) ) ;
        });
    }
