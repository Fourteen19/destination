...
class Vacancy extends Model implements HasMedia
{
    ...
    'role_id', 'region_id', 'client_id', 'all_clients', 'category', 'online_link', 'lead_para', 'description', 'entry_requirements', 'map',
    'display_until', 'created_by', 'updated_at', 'updated_by'];
    ...
    {
        return $this->hasOne('App\Models\VacanciesTotalStats', 'vacancy_id', 'id');
    }
