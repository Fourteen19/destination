...
class ViewComposerServiceProvider extends ServiceProvider
{
    ...
    private function composeFrontendViews()
    {
        ...
        //articles
        view()->composer(['frontend.pages.includes.footer', 'frontend.pages.includes.account-menu', 'frontend.pages.my-account.contact-my-adviser', 'frontend.pages.my-account.meet-your-adviser'], '\App\Http\Composers\Frontend\AdvisorDetailsComposer@compose');
