...
<div class="container-fluid">
    ...
    <h1 class="mb-4">{{ __('ck_admin.manage_keywords.title') }}</h1>

    <p>{{ __('ck_admin.manage_keywords.instructions') }}</p>

    @include('admin.pages.includes.modal')

    <div class="mydir-controls my-4">
    <a href="{{ route('admin.keywords.create') }}" class="mydir-action"><i class="fas fa-plus-square mr-2"></i>New keyword tag</a>
    </div>

    @include('admin.pages.includes.flash-message')

    <table id="keywords_table" class="table table-bordered datatable mydir-table">
        <thead>
            <tr>
                <th>Name</th>
                <th>Actions</th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        let table = $('#keywords_table').DataTable({
            processing: true,
            serverSide: true,
