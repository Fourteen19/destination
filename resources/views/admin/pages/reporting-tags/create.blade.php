...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-8 margin-tb">
            ...
            <h1 class="mb-4">Create Reporting Tag</h1>
            <p class="mydir-instructions">Use this screen to create a reporting tag that can be used to tag articles and then generate bespoke reports within the reporting section.</p>
