...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-8">
        <h1 class="mb-4">Work Experience Activities</h1>
        <p>This report contains all the users and their work experience data for a specific institution, sortedalphanumerically by name.</p>
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-8">
            ...
            <form wire:submit.prevent="submit">
                ...
                @livewire('admin.reporting-activities', ['activities'])
