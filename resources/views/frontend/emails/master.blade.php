...
<body bgcolor="#ffffff">
	...
	<tr>
		...
		<tr>
			...
			<table width="600" align="center" bgcolor="{{$clientSettings['bg1']}}" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; width:600px;" border="0" cellpadding="0" cellspacing="0" class="container-table">
			<tr>
