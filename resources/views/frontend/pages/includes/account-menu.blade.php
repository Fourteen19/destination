<div class="col-lg-2">
    <div class="sticky-p position-sticky">
        <ul class="list-unstyled py-3">			
            <li class="mb-2"><a href="{{ route('frontend.my-account.edit') }}" class="t-up t-wg w900 t16 td-no">Edit my details</a></li>
            ...
            <li class="mb-2"><a href="{{ route('frontend.my-account.contact-my-adviser.edit') }}" class="t-up t-wg w900 t16 td-no">Contact my adviser</a></li>
            <li class="mb-2"><a href="{{ route('frontend.my-account.my-articles.edit') }}" class="t-up t-wg w900 t16 td-no">My articles</a></li>
