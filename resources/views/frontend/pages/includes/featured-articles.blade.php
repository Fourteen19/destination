    ...
    <div class="row vlg-bg r-pad">
        ...
        @foreach ($featuredArticles as $featuredArticle)
            ...
            <div class="col-lg-12 r-base">
                ...
                <img src="{{ !empty($featuredArticle->getFirstMediaUrl('summary', 'summary_slot4-5-6')) ? $featuredArticle->getFirstMediaUrl('summary', 'summary_slot4-5-6') : config('global.default_summary_images.summary_slot4-5-6')}}">
