    ...
    <div class="row justify-content-center">
        <div class="col-10">
            ...
            @foreach($routes as $route)
                ...
                <div class="row">
                    <div class="col-lg-3 offset-lg-1"><div class="fw700 t18 p-2 d-inline-block mr-2">{{$route->name}}</div><a data-toggle="collapse" data-target="#collapse-{{$route->slug}}"  href="#collapse-{{$route->slug}}" role="button" aria-expanded="false" aria-controls="collapse-{{$route->slug}}" class="self-help">?</a></div>
                    <div class="col-lg-6">
