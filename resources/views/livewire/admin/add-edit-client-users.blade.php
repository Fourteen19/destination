<div>
    ...
    <form wire:submit.prevent="submit">
        ...
        <ul class="nav nav-tabs mydir-tabs" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link @if ($activeTab == "user-details") active @endif @if($errors->hasany(['first_name'])) error @endif" data-toggle="tab" href="#user-details" wire:click="updateTab('article-settings')">User details</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" @if ($activeTab == "additional-information") active @endif data-toggle="tab" href="#additional-info">Additional information</a>
            </li>
            <li class="nav-item">
