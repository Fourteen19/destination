<div>
    ...
    <ul class="nav nav-tabs mydir-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link @if ($activeTab == "summary") active @endif @if($errors->hasany(['summary', 'summary_heading', 'summary_text'])) error @endif" data-toggle="tab" href="#summary" data-tab="summary" wire:click="updateTab('summary')">Summary</a>
        </li>
        <li class="nav-item">
