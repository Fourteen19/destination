<div>
    ...
    <ul class="nav nav-tabs mydir-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link @if ($activeTab == "activity-questions") active @endif" data-toggle="tab" href="#main-content" wire:key="activity-questions-tab" wire:click="updateTab('activity-questions')">Questions</a>
        </li>
        <li class="nav-item">
