<ul class="nav nav-tabs mydir-tabs" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" data-toggle="tab" href="#article-settings">Article Settings</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#banner-image">Banner Image</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#main-content">Main Content</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#videos">Videos</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#alternate">Alternate Text</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#filters">Filters</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#previews">Preview</a>
    </li>
  ...
  <div id="article-settings" class="tab-pane active">
        <div class="row">
            <div class="col-lg-6">
    ...
    <div id="banner-image" class="tab-pane fade">
        <div class="row">
            <div class="col-lg-6">
