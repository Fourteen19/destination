<div>
    ...
    <ul class="nav nav-tabs mydir-tabs" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link @if ($activeTab == "content_preview") active @endif" data-toggle="tab" href="#content_preview" wire:click="updateTab('content_preview')">Content Preview</a>
        </li>
        <li class="nav-item">
            <a class="nav-link @if ($activeTab == "summary_preview") active @endif" data-toggle="tab" href="#summary_preview" wire:click="updateTab('summary_preview')">Summary Preview</a>
        </li>
    </ul>
