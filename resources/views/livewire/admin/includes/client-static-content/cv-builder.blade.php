    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="form-group">
                {!! Form::label('cv_introduction', 'Introduction'); !!}
                {!! Form::textarea('cv_introduction', $cv_introduction, array('placeholder' => 'Introduction', 'cols' => "40", 'rows' => "5", 'class' => 'form-control', 'wire:model.defer' => 'cv_introduction')) !!}
            </div>
