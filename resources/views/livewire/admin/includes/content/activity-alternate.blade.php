<div id="alternate" class="tab-pane px-0 @if ($activeTab == "alternate") active @else fade @endif" wire:key="alternate-pane">
    <div class="row">
        <div class="col-lg-8">
            <div class="rounded p-4 form-outer">
                ...
                <div class="form-group">
                    ...
                    {!! Form::textarea('alt_block_text', (!isset($content->contentable->alt_block_text)) ? null : $content->contentable->alt_block_text, array('placeholder' => 'Alternate text block content','class' => 'form-control tiny_alt_block_text', 'maxlength' => 999, 'wire:model.defer' => 'alt_block_text')) !!}
                    </div>
                </div>
