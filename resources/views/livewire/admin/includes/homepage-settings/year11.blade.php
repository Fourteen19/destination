        ...
        <div class="col-lg-6">
            ...
            <div class="rounded p-4 form-outer" x-data="{ year11Slot1IsVisible: @entangle('year11Slot1IsVisible')}">
                ...
                <div class="form-group" x-show="year11Slot1IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year11_slot1_uuid, 'name' => 'year11_slot1_article', 'includeClientArticles' => True, 'key' => "year11_slot1_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year11Slot2IsVisible: @entangle('year11Slot2IsVisible')}">
                ...
                <div class="form-group" x-show="year11Slot2IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year11_slot2_uuid, 'name' => 'year11_slot2_article', 'includeClientArticles' => True, 'key' => "year11_slot2_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year11Slot3IsVisible: @entangle('year11Slot3IsVisible')}">
                ...
                <div class="form-group" x-show="year11Slot3IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year11_slot3_uuid, 'name' => 'year11_slot3_article', 'includeClientArticles' => True, 'key' => "year11_slot3_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year11Slot4IsVisible: @entangle('year11Slot4IsVisible')}">
                ...
                <div class="form-group" x-show="year11Slot4IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year11_slot4_uuid, 'name' => 'year11_slot4_article', 'includeClientArticles' => True, 'key' => "year11_slot4_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year11Slot5IsVisible: @entangle('year11Slot5IsVisible')}">
                ...
                <div class="form-group" x-show="year11Slot5IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year11_slot5_uuid, 'name' => 'year11_slot5_article', 'includeClientArticles' => True, 'key' => "year11_slot5_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year11Slot6IsVisible: @entangle('year11Slot6IsVisible')}">
                ...
                <div class="form-group" x-show="year11Slot6IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year11_slot6_uuid, 'name' => 'year11_slot6_article', 'includeClientArticles' => True, 'key' => "year11_slot6_article"])
                </div>
            </div>
