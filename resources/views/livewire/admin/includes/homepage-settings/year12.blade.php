        ...
        <div class="col-lg-6">
            ...
            <div class="rounded p-4 form-outer" x-data="{ year12Slot1IsVisible: @entangle('year12Slot1IsVisible')}">
                ...
                <div class="form-group" x-show="year12Slot1IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year12_slot1_article, 'name' => 'year12_slot1_article', 'includeClientArticles' => True, 'key' => "year12_slot1_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year12Slot2IsVisible: @entangle('year12Slot2IsVisible')}">
                ...
                <div class="form-group" x-show="year12Slot2IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year12_slot2_article, 'name' => 'year12_slot2_article', 'includeClientArticles' => True, 'key' => "year12_slot2_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year12Slot3IsVisible: @entangle('year12Slot3IsVisible')}">
                ...
                <div class="form-group" x-show="year12Slot3IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year12_slot3_article, 'name' => 'year12_slot3_article', 'includeClientArticles' => True, 'key' => "year12_slot3_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year12Slot4IsVisible: @entangle('year12Slot4IsVisible')}">
                ...
                <div class="form-group" x-show="year12Slot4IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year12_slot4_article, 'name' => 'year12_slot4_article', 'includeClientArticles' => True, 'key' => "year12_slot4_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year12Slot5IsVisible: @entangle('year12Slot5IsVisible')}">
                ...
                <div class="form-group" x-show="year12Slot5IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year12_slot5_article, 'name' => 'year12_slot5_article', 'includeClientArticles' => True, 'key' => "year12_slot5_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year12Slot6IsVisible: @entangle('year12Slot6IsVisible')}">
                ...
                <div class="form-group" x-show="year12Slot6IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year12_slot6_article, 'name' => 'year12_slot6_article', 'includeClientArticles' => True, 'key' => "year12_slot6_article"])
                </div>
            </div>
