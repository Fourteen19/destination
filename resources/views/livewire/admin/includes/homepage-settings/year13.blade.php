        ...
        <div class="col-lg-6">
            ...
            <div class="rounded p-4 form-outer" x-data="{ year13Slot1IsVisible: @entangle('year13Slot1IsVisible')}">
                ...
                <div class="form-group" x-show="year13Slot1IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year13_slot1_uuid, 'name' => 'year13_slot1_article', 'includeClientArticles' => True, 'key' => "year13_slot1_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year13Slot2IsVisible: @entangle('year13Slot2IsVisible')}">
                ...
                <div class="form-group" x-show="year13Slot2IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year13_slot2_uuid, 'name' => 'year13_slot2_article', 'includeClientArticles' => True, 'key' => "year13_slot2_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year13Slot3IsVisible: @entangle('year13Slot3IsVisible')}">
                ...
                <div class="form-group" x-show="year13Slot3IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year13_slot3_uuid, 'name' => 'year13_slot3_article', 'includeClientArticles' => True, 'key' => "year13_slot3_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year13Slot4IsVisible: @entangle('year13Slot4IsVisible')}">
                ...
                <div class="form-group" x-show="year13Slot4IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year13_slot4_uuid, 'name' => 'year13_slot4_article', 'includeClientArticles' => True, 'key' => "year13_slot4_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year13Slot5IsVisible: @entangle('year13Slot5IsVisible')}">
                ...
                <div class="form-group" x-show="year13Slot5IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year13_slot5_uuid, 'name' => 'year13_slot5_article', 'includeClientArticles' => True, 'key' => "year13_slot5_article"])
                </div>
            </div>
            ...
            <div class="rounded p-4 form-outer" x-data="{ year13Slot6IsVisible: @entangle('year13Slot6IsVisible')}">
                ...
                <div class="form-group" x-show="year13Slot6IsVisible">
                    @livewire('admin.homepage-article-selector', ['label' => 'Select article', 'articleUuid' => $year13_slot6_uuid, 'name' => 'year13_slot6_article', 'includeClientArticles' => True, 'key' => "year13_slot6_article"])
                </div>
            </div>
