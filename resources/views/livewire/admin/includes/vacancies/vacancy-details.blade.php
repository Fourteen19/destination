    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                {!! Form::select('role_type', $this->roles, null, ['placeholder' => 'Please select', 'class' => "form-control", 'wire:model' => "role_type", 'id' => "role_type" ]); !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::select('region', $this->regions, null, ['placeholder' => 'Please select', 'class' => "form-control", 'wire:model' => "region", 'id' => "region" ]); !!}
            </div>
