<div>
    ...
    <ul class="nav nav-tabs mydir-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link @if ($activeTab == "vacancy-image") active @endif @if($errors->hasany(['vacancyImage', 'vacancyImage_alt'])) error @endif" data-toggle="tab" href="#vacancy-image" wire:click="updateTab('vacancy-image')">Vacancy Image</a>
        </li>
        <li class="nav-item">
