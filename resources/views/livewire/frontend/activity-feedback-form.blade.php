    ...
    <section class="bg-2 rounded-lg my-5 t-w py-5">
        <div class="row justify-content-center">
            <div class="col-xl-8">
                ...
                <div class="form-row">
                    <div class="col-xl-1"><div class="act-num text-center">1).</div></div>
                ...
                <div class="text-center"><button type="submit" class="platform-button border-0 t-w t20 mt-3">Save my answers</button></div>
                </form>
            </div>
        </div>
    </section>
