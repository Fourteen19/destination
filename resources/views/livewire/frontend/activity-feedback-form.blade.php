    ...
    <section class="bg-2 rounded-lg my-5 t-w py-5">
        <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-10">
                ...
                <div class="form-row">
                    <div class="col-lg-1"><div class="act-num text-lg-center">{{$loop->iteration}}).</div></div>
                ...
                <div class="text-lg-center"><button type="submit" wire:loading.attr="disabled" class="platform-button border-0 t-w t20 mt-3">Save my answers</button></div>
