    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="px-lg-4">
                ...
                <div class="row">
                    <div class="col-12">
                        <a class="examples-link" data-toggle="collapse" href="#ai-example" role="button" aria-expanded="false" aria-controls="ai-example">Need some inspiration, advice and ideas? Click here to see some examples.</a>
