@if ($additional_interests)
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <div class="form-group form-check mb-0">
                            ...
                            <label class="form-check-label ml-1" for="page_break_before_additional_interests">Insert a page break <b>HERE</b></label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12 fw600"><div class="cv-inner-heading">Hobbies, interests & achievements</div></div>
